    ...
    internal static class Program
    {
        ...
        private static int Main(string[] args)
        {
                                         ...
                                         Regex.Replace(
                                             Regex.Replace(
                                                 Regex.Replace(
                                                     ...
                                                     @"^EntityFrameworkCore\.SingleStore\.FunctionalTests\.",
                                                     string.Empty),
                                                 @"\.[^.]+$",
                                                 string.Empty),
                                             @"\.",
                                 ...
                                 .ToArray()))
            {
                ...
                // in a separate file that has the name `<ClassName>.SingleStore.cs`.
                ...
                var customizedFilePath = Path.Combine(
                    ...
                    $"{Path.GetFileNameWithoutExtension(filePath)}.SingleStore{Path.GetExtension(filePath)}");
