...
{
    public abstract class ManyToManyTrackingSingleStoreTestBase<TFixture> : ManyToManyTrackingRelationalTestBase<TFixture>
        where TFixture : ManyToManyTrackingSingleStoreTestBase<TFixture>.ManyToManyTrackingSingleStoreFixtureBase
    {
