...
{
    public class ComplexNavigationsCollectionsQuerySingleStoreTest : ComplexNavigationsCollectionsQueryRelationalTestBase<ComplexNavigationsQuerySingleStoreFixture>
    {
        public ComplexNavigationsCollectionsQuerySingleStoreTest(
