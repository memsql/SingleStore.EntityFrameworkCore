...
public class Ef6GroupBySingleStoreTest : Ef6GroupByTestBase<Ef6GroupBySingleStoreTest.Ef6GroupBySingleStoreFixture>
{
    public Ef6GroupBySingleStoreTest(Ef6GroupBySingleStoreFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
