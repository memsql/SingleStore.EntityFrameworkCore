...
public class EntitySplittingQuerySingleStoreTest : EntitySplittingQueryTestBase
{
    public EntitySplittingQuerySingleStoreTest(ITestOutputHelper testOutputHelper)
    {
