...
using EntityFrameworkCore.SingleStore.Json.Microsoft.Infrastructure.Internal;
    ...
    public class JsonMicrosoftDomChangeTrackingTest : IClassFixture<JsonMicrosoftDomChangeTrackingTest.JsonMicrosoftDomChangeTrackingFixture>
    {
        ...
        public class JsonMicrosoftDomChangeTrackingContext : PoolableDbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
            {
                ...
                {
                    ((IDbContextOptionsBuilderInfrastructure)optionsBuilder).AddOrUpdateExtension((SingleStoreJsonMicrosoftOptionsExtension)
                        (optionsBuilder.Options.FindExtension<SingleStoreJsonMicrosoftOptionsExtension>() ??
                         new SingleStoreJsonMicrosoftOptionsExtension())
