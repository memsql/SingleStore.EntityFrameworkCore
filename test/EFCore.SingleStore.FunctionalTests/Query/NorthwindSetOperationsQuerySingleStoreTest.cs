...
{
    public class NorthwindSetOperationsQuerySingleStoreTest : NorthwindSetOperationsQueryRelationalTestBase<
        NorthwindQuerySingleStoreFixture<NoopModelCustomizer>>
    {
        public NorthwindSetOperationsQuerySingleStoreTest(
