...
namespace EntityFrameworkCore.SingleStore.FunctionalTests.Query
{
    ...
    internal class SpatialQuerySingleStoreTest : SpatialQueryRelationalTestBase<SpatialQuerySingleStoreFixture>
    {
        public SpatialQuerySingleStoreTest(SpatialQuerySingleStoreFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
