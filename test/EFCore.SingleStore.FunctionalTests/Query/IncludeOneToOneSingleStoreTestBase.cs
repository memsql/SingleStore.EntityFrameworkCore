...
{
    public abstract class IncludeOneToOneSingleStoreTestBase<TFixture> : IClassFixture<TFixture>
        where TFixture : IncludeOneToOneSingleStoreTestBase<TFixture>.OneToOneQuerySingleStoreFixtureBase, new()
    {
        protected IncludeOneToOneSingleStoreTestBase(TFixture fixture)
            => Fixture = fixture;
        ...
        public abstract class OneToOneQuerySingleStoreFixtureBase : SharedStoreFixtureBase<PoolableDbContext>
        {
            ...
            protected override void OnModelCreating(ModelBuilder modelBuilder, DbContext context)
            {
                ...
                modelBuilder.Entity<Address2>().Property<long>("PersonId");
