...
public class SqlQuerySingleStoreTest : SqlQueryTestBase<NorthwindQuerySingleStoreFixture<NoopModelCustomizer>>
{
    public SqlQuerySingleStoreTest(NorthwindQuerySingleStoreFixture<NoopModelCustomizer> fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
