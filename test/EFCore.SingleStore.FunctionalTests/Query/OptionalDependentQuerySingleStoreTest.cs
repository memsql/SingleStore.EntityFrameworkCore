...
internal class OptionalDependentQuerySingleStoreTest : OptionalDependentQueryTestBase<OptionalDependentQuerySingleStoreFixture>
{
    public OptionalDependentQuerySingleStoreTest(OptionalDependentQuerySingleStoreFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
