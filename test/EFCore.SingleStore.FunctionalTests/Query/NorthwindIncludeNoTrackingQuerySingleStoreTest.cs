...
{
    public class NorthwindIncludeNoTrackingQuerySingleStoreTest : NorthwindIncludeNoTrackingQueryTestBase<NorthwindQuerySingleStoreFixture<NoopModelCustomizer>>
    {
        // ReSharper disable once UnusedParameter.Local
        public NorthwindIncludeNoTrackingQuerySingleStoreTest(NorthwindQuerySingleStoreFixture<NoopModelCustomizer> fixture)
            : base(fixture)
        {
            ClearLog();
        }
