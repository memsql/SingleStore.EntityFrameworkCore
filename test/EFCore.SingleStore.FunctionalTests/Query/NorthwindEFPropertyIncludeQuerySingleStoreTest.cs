...
public class NorthwindEFPropertyIncludeQuerySingleStoreTest : NorthwindEFPropertyIncludeQueryTestBase<
    NorthwindQuerySingleStoreFixture<NoopModelCustomizer>>
{
    // ReSharper disable once UnusedParameter.Local
    public NorthwindEFPropertyIncludeQuerySingleStoreTest(NorthwindQuerySingleStoreFixture<NoopModelCustomizer> fixture)
        : base(fixture)
    {
