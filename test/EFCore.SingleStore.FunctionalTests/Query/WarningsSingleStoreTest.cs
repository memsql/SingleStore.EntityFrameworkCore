...
namespace EntityFrameworkCore.SingleStore.FunctionalTests.Query
{
    public class WarningsSingleStoreTest : WarningsTestBase<QueryNoClientEvalSingleStoreFixture>
    {
        ...
        [ConditionalFact(Skip = "Feature 'Correlated subselect that can not be transformed and does not match on shard keys' is not supported by SingleStore Distributed")]
