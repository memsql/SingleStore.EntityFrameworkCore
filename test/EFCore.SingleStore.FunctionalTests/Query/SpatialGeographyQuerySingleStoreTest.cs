...
{
    // Made internal to skip all tests (TODO: PLAT-6286)
    internal class SpatialGeographyQuerySingleStoreTest : QueryTestBase<SpatialGeographyQuerySingleStoreTest.SpatialGeographyQuerySingleStoreFixture>
    {
        public SpatialGeographyQuerySingleStoreTest(SpatialGeographyQuerySingleStoreFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
