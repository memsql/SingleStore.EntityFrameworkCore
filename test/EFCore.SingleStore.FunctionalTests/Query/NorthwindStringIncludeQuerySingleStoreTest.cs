...
{
    public class NorthwindStringIncludeQuerySingleStoreTest : NorthwindStringIncludeQueryTestBase<NorthwindQuerySingleStoreFixture<NoopModelCustomizer>>
    {
        // ReSharper disable once UnusedParameter.Local
        public NorthwindStringIncludeQuerySingleStoreTest(NorthwindQuerySingleStoreFixture<NoopModelCustomizer> fixture)
            : base(fixture)
        {
            ClearLog();
        }
