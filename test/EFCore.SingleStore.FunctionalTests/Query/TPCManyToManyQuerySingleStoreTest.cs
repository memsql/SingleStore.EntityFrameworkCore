...
public class TPCManyToManyQuerySingleStoreTest : TPCManyToManyQueryRelationalTestBase<TPCManyToManyQuerySingleStoreFixture>
{
    public TPCManyToManyQuerySingleStoreTest(TPCManyToManyQuerySingleStoreFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
