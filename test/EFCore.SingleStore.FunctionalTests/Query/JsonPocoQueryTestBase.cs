...
WHERE JSON_TYPE(JSON_EXTRACT(`j`.`Customer`, '$.Statistics.Visits')) = 'INTEGER'");
        ...
        public class JsonPocoQueryFixtureBase : SharedStoreFixtureBase<JsonPocoQueryContext>
        {
            ...
            // We explicitly setup SingleStoreGuidFormat.Binary16 here, to ensure that this is being ignored for JSON values, and instead
            // SingleStoreGuidFormat.Char36 is being used.
            protected override ITestStoreFactory TestStoreFactory => SingleStoreTestStoreFactory.GuidBinary16Instance;
