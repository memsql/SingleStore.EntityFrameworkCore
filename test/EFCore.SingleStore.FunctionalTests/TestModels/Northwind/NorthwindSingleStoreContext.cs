...
namespace EntityFrameworkCore.SingleStore.FunctionalTests.TestModels.Northwind;

public class NorthwindSingleStoreContext : NorthwindRelationalContext
{
    public NorthwindSingleStoreContext(DbContextOptions options)
        : base(options)
    {
    }
