...
public class SingleStoreXunitTestCollectionRunner : XunitTestCollectionRunner
{
    public SingleStoreXunitTestCollectionRunner(
    ...
    protected override async Task<RunSummary> RunTestClassesAsync()
    {
        ...
        if (TestCaseOrderer is ISingleStoreTestClassOrderer testClassOrderer)
        {
