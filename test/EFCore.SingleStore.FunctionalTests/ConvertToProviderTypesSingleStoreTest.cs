...
{
    public class ConvertToProviderTypesSingleStoreTest : ConvertToProviderTypesTestBase<ConvertToProviderTypesSingleStoreTest.ConvertToProviderTypesSingleStoreFixture>
    {
        public ConvertToProviderTypesSingleStoreTest(ConvertToProviderTypesSingleStoreFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
        ...
        public class ConvertToProviderTypesSingleStoreFixture : ConvertToProviderTypesFixtureBase
        {
