...
{
    public class CustomConvertersSingleStoreTest : CustomConvertersTestBase<CustomConvertersSingleStoreTest.CustomConvertersSingleStoreFixture>
    {
        public CustomConvertersSingleStoreTest(CustomConvertersSingleStoreFixture fixture)
            : base(fixture)
        {
        }
        ...
        public class CustomConvertersSingleStoreFixture : CustomConvertersFixtureBase
        {
            ...
            protected override void OnModelCreating(ModelBuilder modelBuilder, DbContext context)
            {
                ...
                var ciCollation = ((SingleStoreTestStore)TestStore).ServerVersion.Value.DefaultUtf8CiCollation;
