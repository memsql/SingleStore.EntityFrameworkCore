...
{
    public partial class SingleStoreMigrationsSqlGeneratorTest : MigrationsSqlGeneratorTestBase
    {
        public SingleStoreMigrationsSqlGeneratorTest()
            : base(
                SingleStoreTestHelpers.Instance,
                new ServiceCollection().AddEntityFrameworkSingleStoreNetTopologySuite(),
                SingleStoreTestHelpers.Instance.AddProviderOptions(
                    ((IRelationalDbContextOptionsBuilderInfrastructure)
                        new SingleStoreDbContextOptionsBuilder(new DbContextOptionsBuilder()).UseNetTopologySuite())
        ...
        [ConditionalFact(Skip = "TODO: GEOMETRY -> GEOGRAPHY")]
...
",
        ...
        {
            Generate(new SingleStoreCreateDatabaseOperation { Name = "Northwind" });
        ...
        {
            Generate(new SingleStoreCreateDatabaseOperation { Name = "Northwind", CharSet = "latin1"});
        ...
        {
            Generate(new SingleStoreCreateDatabaseOperation { Name = "Northwind", Collation = "latin1_general_ci"});
        ...
        {
            Generate(
                new SingleStoreCreateDatabaseOperation {Name = "Northwind", CharSet = "latin1"},
                new AlterDatabaseOperation {[SingleStoreAnnotationNames.CharSet] = "utf8mb4"});
...
ALTER DATABASE CHARACTER SET utf8mb4;" + EOL,
        ...
        {
            Generate(
                new SingleStoreCreateDatabaseOperation {Name = "Northwind", Collation = "latin1_general_ci"},
...
ALTER DATABASE COLLATE latin1_swedish_ci;" + EOL,
                ...
                new CreateTableOperation
                {
                    ...
                    Columns =
                    {
                        new AddColumnOperation
                        {
                            ...
                            IsNullable = false,
                            [SingleStoreAnnotationNames.ValueGenerationStrategy] = SingleStoreValueGenerationStrategy.IdentityColumn
                        }
                    },
        ...
        public virtual void AddColumnOperation_with_charset_implicit(bool? isUnicode, bool isIndex, string charSetName)
        {
            ...
            Generate(
                ...
                modelBuilder =>
                {
                    ...
                    if (charSet != null)
                    {
                        addColumn.Annotation(SingleStoreAnnotationNames.CharSet, charSet);
                    }
                }
            );

            var columnType = isIndex
                ? $"varchar({SingleStoreTestHelpers.Instance.GetIndexedStringPropertyDefaultLength})"
                : "longtext";
        ...
        public virtual void AddColumnOperation_with_computed_column()
        {
            Generate(
                new AddColumnOperation
                {
                    ...
                    IsNullable = true,
                    [SingleStoreAnnotationNames.ValueGenerationStrategy] = SingleStoreValueGenerationStrategy.ComputedColumn
                });
        ...
        public virtual void AddColumnOperation_serial()
        {
            ...
            Assert.Equal(
                "ALTER TABLE `People` ADD `foo` bigint NOT NULL AUTO_INCREMENT;" + EOL,
                Sql);
        }
        ...
        public void AlterColumnOperation_ComputedColumnSql_stored()
        {
            ...
            Assert.Equal(
                "ALTER TABLE `Universes` ADD `AnswerToEverything` AS (6 * 9) PERSISTED int;" + EOL,
                Sql);
        }
        ...
        [ConditionalFact(Skip = "FULLTEXT indexes can only be enabled as part of a CREATE TABLE query.")]
        public virtual void CreateIndexOperation_fulltext()
        {
            Generate(
                new CreateIndexOperation
                {
                    ...
                    [SingleStoreAnnotationNames.FullTextIndex] = true
                });
        ...
        public virtual void CreateIndexOperation_fulltext_with_parser()
        {
            Generate(
                new CreateIndexOperation
                {
                    ...
                    Columns = new[] { "FirstName", "LastName" },
                    [SingleStoreAnnotationNames.FullTextIndex] = true,
                    [SingleStoreAnnotationNames.FullTextParser] = "ngram",
                });
        ...
        public virtual void CreateIndexOperation_spatial()
        {
            ...
            Generate(
                new CreateIndexOperation
                {
                    ...
                    Table = "People",
                    Columns = new[] { "FirstName", "LastName" },
                    [SingleStoreAnnotationNames.SpatialIndex] = true
                });
        ...
        {
            var migrationBuilder = new MigrationBuilder("SingleStore");
        ...
        public virtual void RenameIndexOperations_throws_when_no_table()
        {
            ...
            Assert.Equal(SingleStoreStrings.IndexTableRequired, ex.Message);
        }
        ...
        public virtual void RenameColumnOperation()
        {
            ...
            Assert.Equal(
                "ALTER TABLE `Person` CHANGE `Name` `FullName`;" + EOL,
                Sql);
        }
        ...
        public virtual void AddColumnOperation_with_charset_annotation()
        {
            Generate(
                new AddColumnOperation
                {
                    ...
                    ColumnType = "varchar(255)",
                    IsNullable = true,
                    [SingleStoreAnnotationNames.CharSet] = CharSet.SJis,
                });
        ...
        public virtual void CreateIndexOperation_with_prefix_lengths()
        {
            Generate(
                ...
                new CreateIndexOperation
                {
                    ...
                    [SingleStoreAnnotationNames.IndexPrefixLength] = new [] { 0, 20 }
                });
                ...
                new CreateTableOperation
                {
                    ...
                    Columns =
                    {
                        new AddColumnOperation
                        {
                            ...
                            ColumnType = "longtext",
                            ClrType = typeof(string),
                            [SingleStoreAnnotationNames.CharSet] = "utf8mb4"
                        },
                        new AddColumnOperation
                        {
                            Name = "Name",
                    ...
                    [SingleStoreAnnotationNames.CharSet] = "latin1",
                });
    ...
    PRIMARY KEY (`Name`, `Brand`(20))
        ...
        public virtual void AlterTableOperation_with_charset()
        {
            Generate(
                ...
                {
                    migrationBuilder.AlterTable("IceCreams")
                        .OldAnnotation(SingleStoreAnnotationNames.CharSet, "latin1")
                        .Annotation(SingleStoreAnnotationNames.CharSet, "utf8mb4");
                });
...
DEALLOCATE PREPARE __pomelo_SqlExprExecute;" + EOL,
        ...
        public virtual void CreateTableOperation_with_table_options()
        {
            Generate(
                new CreateTableOperation
                {
                    ...
                    [SingleStoreAnnotationNames.StoreOptions] = "CHECKSUM=1,MAX_ROWS=100",
                });
    ...
    PRIMARY KEY (`Name`)
        ...
        public virtual void AlterTableOperation_with_table_options()
        {
            Generate(
                ...
                {
                    migrationBuilder.AlterTable("IceCreams")
                        .OldAnnotation(SingleStoreAnnotationNames.StoreOptions, "CHECKSUM=1,MAX_ROWS=100")
                        .Annotation(SingleStoreAnnotationNames.StoreOptions, "CHECKSUM=1,MIN_ROWS=20,MAX_ROWS=200");
                });
    ...
    PRIMARY KEY (`Name`, `Brand`(20))
        ...
        protected new void AssertSql(string expected)
        {
            ...
            var logger = testSqlLoggerFactory.CreateLogger(nameof(SingleStoreMigrationsSqlGeneratorTest));
            logger.Log(
        ...
        protected virtual void Generate(
            Action<SingleStoreDbContextOptionsBuilder> optionsAction,
            Action<ModelBuilder> buildAction,
            ...
            MigrationsSqlGenerationOptions options)
        {
            ...
            var mySqlOptionsBuilder = new SingleStoreDbContextOptionsBuilder(optionsBuilder);

            mySqlOptionsBuilder.SchemaBehavior(SingleStoreSchemaBehavior.Ignore);
