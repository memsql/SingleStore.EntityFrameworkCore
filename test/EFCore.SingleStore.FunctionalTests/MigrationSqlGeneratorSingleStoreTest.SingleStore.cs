                ...
                new CreateTableOperation
                {
                    ...
                    Columns =
                    {
                        new AddColumnOperation
                        {
                            ...
                            ColumnType = "GEOMETRY",
                            [SingleStoreAnnotationNames.SpatialReferenceSystemId] = 0,
                        }
                    }
                });
                ...
                new CreateTableOperation
                {
                    ...
                    Columns =
                    {
                        new AddColumnOperation
                        {
                            ...
                            ClrType = typeof(Point),
                            ColumnType = "POINT",
                            [SingleStoreAnnotationNames.SpatialReferenceSystemId] = 4326,
                        }
                    }
                });
        ...
        public virtual void CreateTable_with_SchemaNameTranslator()
        {
            Generate(
                optionsBuilder => optionsBuilder.SchemaBehavior(
                    SingleStoreSchemaBehavior.Translate,
...
",
        ...
        public virtual void CreateTable_with_ValueGenerationStrategy_int_value()
        {
                ...
                new CreateTableOperation
                {
                    ...
                    Columns =
                    {
                        new AddColumnOperation
                        {
                            ...
                            ClrType = typeof(int),
                            ColumnType = "bigint",
                            [SingleStoreAnnotationNames.ValueGenerationStrategy] = (int)SingleStoreValueGenerationStrategy.IdentityColumn,
                        }
                    }
                });
            ...
            Assert.Equal(
                @"CREATE TABLE `IceCreamShops` (
    `IceCreamShopId` bigint NOT NULL AUTO_INCREMENT
);
",
                Sql,
                ignoreLineEndingDifferences: true);
