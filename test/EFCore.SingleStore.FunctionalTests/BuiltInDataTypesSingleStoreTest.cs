...
namespace EntityFrameworkCore.SingleStore.FunctionalTests
{
    ...
    public class BuiltInDataTypesSingleStoreTest :
        BuiltInDataTypesTestBase<BuiltInDataTypesSingleStoreTest.BuiltInDataTypesSingleStoreFixture>
    {
        public BuiltInDataTypesSingleStoreTest(BuiltInDataTypesSingleStoreFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
...
WHERE `m`.`TimeSpanAsTime` = '00:01:02':>time(6)",
                    Sql,
...
SELECT `m`.`Int`
FROM `MappedNullableDataTypes` AS `m`
WHERE `m`.`TimeSpanAsTime` = @__timeSpan_0:>time(6)",
                    Sql,
                    ignoreLineEndingDifferences: true);
            }
        }
...
@p9='73'
@p10='A' (Nullable = false) (Size = 1)
@p11='2015-01-02T10:11:12.0000000' (DbType = Date)
@p12='2019-01-02T14:11:12.0000000' (DbType = DateTime)
@p13='2016-01-02T11:11:12.0000000+00:00'
@p14='2017-01-02T12:11:12.0000000+02:00'
@p15='81.1'
@p16='85.5'
@p17='83.3'
@p18='Value2' (Nullable = false) (Size = 20)
@p19='a8f9f951-145f-4545-ac60-b92ff57ada47'
@p20='2011' (DbType = Int32)
@p21='78'
@p22='-128'
@p23='128'
@p24='79'
@p25='Your' (Nullable = false) (Size = 10) (DbType = StringFixedLength)
@p26='{""a"":""b""}' (Nullable = false) (Size = 4000)
@p27='arm' (Nullable = false) (Size = 4000)
@p28='anyone!' (Nullable = false) (Size = 4000)
@p29='Gumball Rules!' (Nullable = false) (Size = 4000)
@p30='help' (Nullable = false) (Size = 4000)
@p31='" + entity.StringAsVarchar + @"' (Nullable = false) (Size = -1)
@p32='11:15:12'
@p33='65535'
@p34='65535'
@p35='42' (DbType = Int32)
@p36='4294967295'
@p37='4294967295'
@p38='18446744073709551615'
@p39='18446744073709551615'",
                parameters,
                ignoreLineEndingDifferences: true);
...
@p7='G' (Size = 1)
@p8='A' (Size = 1)
@p9='2015-01-02T10:11:12.0000000' (Nullable = true) (DbType = Date)
@p10='2019-01-02T14:11:12.0000000' (Nullable = true) (DbType = DateTime)
@p11='2016-01-02T11:11:12.0000000+00:00' (Nullable = true) (Size = 6)
@p12='2017-01-02T12:11:12.0000000+06:00' (Nullable = true) (Size = 6)
@p13='81.1' (Nullable = true)
@p14='82.2' (Nullable = true)
@p15='85.5' (Nullable = true)
@p16='83.3' (Nullable = true)
@p17='Value2' (Size = 20)
@p18='84.4' (Nullable = true)
@p19='a8f9f951-145f-4545-ac60-b92ff57ada47' (Nullable = true)
@p20='2011' (Nullable = true) (DbType = Int32)
@p21='78' (Nullable = true)
@p22='-128' (Nullable = true)
@p23='-128' (Nullable = true)
@p24='79' (Nullable = true)
@p25='C' (Size = 20) (DbType = StringFixedLength)
@p26='{""a"":""b""}' (Size = 4000)
@p27='anyone!' (Size = 4000)
@p28='Gumball Rules!' (Size = 4000)
@p29='help' (Size = 4000)
@p30='strong' (Size = 55)
@p31='11:15:12' (Nullable = true)
@p32='65535' (Nullable = true)
@p33='-1' (Nullable = true)
@p34='42' (Nullable = true) (DbType = Int32)
@p35='4294967295' (Nullable = true)
@p36='-1' (Nullable = true)
@p37='-1' (Nullable = true)
@p38='18446744073709551615' (Nullable = true)",
                parameters,
                ignoreLineEndingDifferences: true);
...
@p8=NULL (Size = 1)
@p9=NULL (DbType = Date)
@p10=NULL (DbType = DateTime)
@p11=NULL (Size = 6) (DbType = DateTimeOffset)
@p12=NULL (Size = 6) (DbType = DateTimeOffset)
@p13=NULL
@p14=NULL
@p15=NULL (DbType = Double)
@p16=NULL (DbType = Double)
@p17=NULL (Size = 20)
@p18=NULL (DbType = Single)
@p19=NULL (DbType = Guid)
@p20=NULL (DbType = Int32)
@p21=NULL (DbType = Int64)
@p22=NULL (DbType = Int16)
@p23=NULL (DbType = SByte)
@p24=NULL (DbType = Int16)
@p25=NULL (Size = 20) (DbType = StringFixedLength)
@p26=NULL (Size = 4000)
@p27=NULL (Size = 4000)
@p28=NULL (Size = 4000)
@p29=NULL (Size = 4000)
@p30=NULL (Size = 55)
@p31=NULL (DbType = Time)
@p32=NULL (DbType = Int32)
@p33=NULL (DbType = Int16)
@p34=NULL (DbType = Int32)
@p35=NULL (DbType = Int64)
...
BuiltInNullableDataTypes.TestString ---> [nullable longtext] [MaxLength = 4294967295]
...
BuiltInNullableDataTypesShadow.TestString ---> [nullable longtext] [MaxLength = 4294967295]
DateTimeEnclosure.DateTimeOffset ---> [nullable datetime] [Precision = 6]
DateTimeEnclosure.Id ---> [bigint] [Precision = 19 Scale = 0]
...
MappedDataTypes.DateTimeOffsetAsTimestamp ---> [timestamp]
...
MappedDataTypes.StringAsLongtext ---> [longtext] [MaxLength = 4294967295]
...
MappedDataTypes.TimeSpanAsTime ---> [time]
...
MappedNullableDataTypes.DateTimeOffsetAsTimestamp ---> [nullable timestamp]
...
MappedNullableDataTypes.StringAsText ---> [nullable text] [MaxLength = 65535]
...
MappedNullableDataTypes.TimeSpanAsTime ---> [nullable time]
...
StringEnclosure.Id ---> [bigint] [Precision = 19 Scale = 0]
StringEnclosure.Value ---> [nullable longtext] [MaxLength = 4294967295]
StringKeyDataType.Id ---> [varchar] [MaxLength = 255]
UnicodeDataTypes.Id ---> [int] [Precision = 10 Scale = 0]
UnicodeDataTypes.StringAnsi ---> [nullable longtext] [MaxLength = 4294967295]
UnicodeDataTypes.StringAnsi3 ---> [nullable varchar] [MaxLength = 3]
UnicodeDataTypes.StringAnsi9000 ---> [nullable varchar] [MaxLength = 9000]
UnicodeDataTypes.StringDefault ---> [nullable longtext] [MaxLength = 4294967295]
UnicodeDataTypes.StringUnicode ---> [nullable longtext] [MaxLength = 4294967295]
";
 ...
 WHERE `TABLE_SCHEMA` like '%uilt%ata%'";
            ...
            using (context)
            {
                ...
                using (var reader = command.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        ...
                        var charSet = reader.IsDBNull(8) ? null : reader.GetString(8);

                        if (AppConfig.ServerVersion.Supports.TextTypeSizeIsInCharacters &&
                            columnInfo.DataType is "text" or "tinytext" or "mediumtext" or "longtext")
                        {
                            columnInfo.MaxLength *= CharSet.GetCharSetFromName(charSet).MaxBytesPerChar;
                        }
        ...
        public class BuiltInDataTypesSingleStoreFixture : BuiltInDataTypesFixtureBase
        {
            public override string ReallyLargeString
                => string.Join("", Enumerable.Repeat(Environment.NewLine, 400));
