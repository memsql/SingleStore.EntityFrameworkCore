...
{
    public abstract class WithConstructorsSingleStoreTestBase<TFixture> : IClassFixture<TFixture>
        where TFixture : WithConstructorsSingleStoreTestBase<TFixture>.WithConstructorsSingleStoreFixtureBase, new()
    {
        protected WithConstructorsSingleStoreTestBase(TFixture fixture)
            => Fixture = fixture;
            ...
            where TContext : DbContext
        {
            ...
            private HasContext(TContext context, long id)
            {
                Context = context;
                Id = id;
            }
            ...
            where TContext : DbContext
        {
            ...
            private HasContextPc(TContext context, long id)
            {
                _context = context;
                Id = id;
            }
        ...
        protected class LazyPropertyPost
        {
            ...
            public long Id { get; set; }
            public bool Filler { get; set; }
            public long LazyPropertyBlogId { get; set; }
...
#pragma warning restore 649
            ...
            public long Id { get; set; }
            public bool Filler { get; set; }
            public long LazyFieldBlogId { get; set; }
        ...
        protected class LazyPcsPost
        {
            ...
            public long Id { get; set; }
            public bool Filler { get; set; }
            public long LazyPcsBlogId { get; set; }
    ...
    public abstract class WithConstructorsSingleStoreFixtureBase : SharedStoreFixtureBase<WithConstructorsContext>
    {
