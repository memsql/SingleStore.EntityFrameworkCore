...
{
    public class OptimisticConcurrencySingleStoreTest : OptimisticConcurrencyRelationalTestBase<F1SingleStoreFixture, byte[]>
    {
        public OptimisticConcurrencySingleStoreTest(F1SingleStoreFixture fixture)
            : base(fixture)
        {
        }
