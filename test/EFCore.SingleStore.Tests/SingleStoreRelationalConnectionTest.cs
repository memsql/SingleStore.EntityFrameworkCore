...
public class SingleStoreRelationalConnectionTest
{
    [Fact]
    public void Creates_SingleStore_Server_connection_string()
    {
    ...
    public void Uses_DbDataSource_from_DbContextOptions()
    {
        ...
        serviceCollection
            .AddSingleStoreDataSource("Server=FakeHost")
            .AddDbContext<FakeDbContext>(o => o.UseSingleStore(dataSource));

        using var serviceProvider = serviceCollection.BuildServiceProvider();

        using var scope1 = serviceProvider.CreateScope();
        var context1 = scope1.ServiceProvider.GetRequiredService<FakeDbContext>();
        var relationalConnection1 = (SingleStoreRelationalConnection)context1.GetService<IRelationalConnection>()!;
    ...
    {
        using var dataSource = new SingleStoreDataSourceBuilder("Server=FakeHost").Build();

        var serviceCollection = new ServiceCollection();

        serviceCollection
            .AddSingleStoreDataSource("Server=FakeHost;Allow User Variables=True;Use Affected Rows=False")
            .AddDbContext<FakeDbContext>(o => o.UseSingleStore(dataSource));
    ...
    public void Uses_DbDataSource_from_ApplicationServiceProvider()
    {
        ...
        serviceCollection
            .AddSingleStoreDataSource("Server=FakeHost;Allow User Variables=True;Use Affected Rows=False")
            .AddDbContext<FakeDbContext>(o => o.UseSingleStore());
    ...
    public void Uses_correct_DbDataSource_from_ApplicationServiceProvider_with_cached_DbContextOptions_extension()
    {
        ...
        serviceCollection1
            .AddSingleStoreDataSource("Server=FakeHost1;Allow User Variables=True;Use Affected Rows=False")
            .AddDbContext<FakeDbContext>(o => o.UseSingleStore());

        using (var serviceProvider1 = serviceCollection1.BuildServiceProvider())
        {
            var dataSource1 = serviceProvider1.GetRequiredService<SingleStoreDataSource>();
            ...
            var mySqlOptions1 = context1.GetService<ISingleStoreOptions>();
        ...
        serviceCollection2
            .AddSingleStoreDataSource("Server=FakeHost2;Allow User Variables=True;Use Affected Rows=False")
            .AddDbContext<FakeDbContext>(o => o.UseSingleStore());

        using (var serviceProvider2 = serviceCollection2.BuildServiceProvider())
        {
            var dataSource2 = serviceProvider2.GetRequiredService<SingleStoreDataSource>();
            ...
            var mySqlOptions2 = context2.GetService<ISingleStoreOptions>();
    ...
    //         .UseSingleStore(
    //             @"Server=localhost;Database=SingleStoreConnectionTest;User ID=some_user;Password=some_password",
    ...
    //     var options = new DbContextOptionsBuilder()
    //         .UseSingleStore(
    //             @"Server=localhost;Database=SingleStoreConnectionTest;User ID=some_user;Password=some_password;Auto Enlist=" + falseValue,
    ...
    public void CurrentAmbientTransaction_returns_transaction_with_AutoEnlist_enabled(string autoEnlist)
    {
        var options = new DbContextOptionsBuilder()
            .UseSingleStore(
                @"Server=localhost;Database=SingleStoreConnectionTest;User ID=some_user;Password=some_password" + autoEnlist)
            .Options;
    ...
    // INFO: We currently don't implement ISingleStoreRelationalConnection.CloneWith.
    //
    // [ConditionalFact]
    // public void CloneWith_with_connection_and_connection_string()
    // {
    //     var services = SingleStoreTestHelpers.Instance.CreateContextServices(
    //         new DbContextOptionsBuilder()
    //             .UseSingleStore("Server=localhost;Database=DummyDatabase", AppConfig.ServerVersion)
    //             .Options);
    //
    //     var relationalConnection = (ISingleStoreRelationalConnection)services.GetRequiredService<IRelationalConnection>();
    //
    ...
    private static SingleStoreRelationalConnection CreateConnection(DbContextOptions options = null, DbDataSource dataSource = null)
    {
        ...
        var singletonOptions = new SingleStoreOptions();
        ...
        return new SingleStoreRelationalConnection(
            ...
            new SingleStoreConnectionStringOptionsValidator(),
            singletonOptions);
    }
