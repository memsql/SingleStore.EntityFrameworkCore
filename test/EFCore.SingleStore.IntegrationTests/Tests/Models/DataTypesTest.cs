    ...
    public class DataTypesTest
    {
        ...
        public async Task TestDataTypesSimple()
        {
            void testEmpty(DataTypesSimple emptyDb)
            {
                ...
                // DateTime
                Assert.Equal(DataTypesSimple.EmptyDateTime, emptyDb.TypeDateTime);
                Assert.Equal(DataTypesSimple.EmptyDateTimeOffset, emptyDb.TypeDateTimeOffset);
                Assert.Equal(DataTypesSimple.EmptyTimeSpan, emptyDb.TypeTimeSpan);
                // nullable DateTime
