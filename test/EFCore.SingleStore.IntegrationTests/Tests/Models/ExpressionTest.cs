...
namespace EntityFrameworkCore.SingleStore.IntegrationTests.Tests.Models
{
    ...
    public class ExpressionTest : IDisposable
    {
        ...
        [Fact]
        public async Task SingleStoreContainsOptimizedTranslator()
        {
        ...
        [Fact]
        public async Task SingleStoreDateAddTranslator()
        {
        ...
        [Fact]
        public async Task SingleStoreDatePartTranslator()
        {
            var result = await _db.DataTypesSimple.Select(m =>
                new {
                    m.Id,
...
#pragma warning restore EF1002
        ...
        [Fact]
        public async Task SingleStoreEndsWithOptimizedTranslator()
        {
            var result = await _db.DataTypesVariable.Select(m =>
                new {
                    m.Id,
        ...
        [Fact]
        public async Task SingleStoreMathAbsTranslator()
        {
            var result = await _db.DataTypesSimple.Select(m =>
                new {
                    m.Id,
        ...
        [Fact]
        public async Task SingleStoreMathCeilingTranslator()
        {
            var result = await _db.DataTypesSimple.Select(m =>
                new {
                    m.Id,
        ...
        [Fact]
        public async Task SingleStoreMathFloorTranslator()
        {
            var result = await _db.DataTypesSimple.Select(m =>
                new {
                    m.Id,
        ...
        [Fact]
        public async Task SingleStoreMathPowerTranslator()
        {
            var result = await _db.DataTypesSimple.Select(m =>
                new {
                    m.Id,
        ...
        [Fact]
        public async Task SingleStoreMathRoundTranslator()
        {
            var result = await _db.DataTypesSimple.Select(m =>
                new {
                    m.Id,
        ...
        [Fact]
        public async Task SingleStoreMathTruncateTranslator()
        {
            var result = await _db.DataTypesSimple.Select(m =>
                new {
                    m.Id,
        ...
        [Fact]
        public async Task SingleStoreNewGuidTranslator()
        {
            var result = await _db.DataTypesSimple.Select(m =>
                new {
                    m.Id,
        ...
        [Fact]
        public async Task SingleStoreRegexIsMatchTranslator()
        {
            var result = await _db.DataTypesVariable.Select(m =>
                new {
                    m.Id,
        ...
        [Fact]
        public async Task SingleStoreStringEqualsTranslator()
        {
            var result = await _db.DataTypesVariable.Select(m =>
                new {
                    m.Id,
        ...
        [Fact]
        public async Task SingleStoreStartsWithOptimizedTranslator()
        {
            var result = await _db.DataTypesVariable.Select(m =>
                new {
                    m.Id,
        ...
        [Fact]
        public async Task SingleStoreStringLengthTranslator()
        {
            var result = await _db.DataTypesVariable.Select(m =>
                new {
                    m.Id,
        ...
        [Fact]
        public async Task SingleStoreStringReplaceTranslator()
        {
            var result = await _db.DataTypesVariable.Select(m =>
                new {
                    m.Id,
                    Replaced = m.TypeString.Replace("Entity", "Entity")
                }).FirstOrDefaultAsync(m => m.Id == _variable.Id);

            Assert.Equal("EntityFramework", result.Replaced);
        }

        [Fact]
        public async Task SingleStoreStringSubstringTranslator()
        {
            var result = await _db.DataTypesVariable.Select(m =>
                new {
                    m.Id,
        ...
        [Fact]
        public async Task SingleStoreStringToLowerTranslator()
        {
            var result = await _db.DataTypesVariable.Select(m =>
                new {
                    m.Id,
        ...
        [Fact]
        public async Task SingleStoreStringToUpperTranslator()
        {
            var result = await _db.DataTypesVariable.Select(m =>
                new {
                    m.Id,
        ...
        [Fact]
        public async Task SingleStoreMathAcosTranslator()
        {
            var result = await _db.DataTypesSimple.Select(m =>
                new {
                    m.Id,
        ...
        [Fact]
        public async Task SingleStoreMathCosTranslator()
        {
            var result = await _db.DataTypesSimple.Select(m =>
                new {
                    m.Id,
        ...
        [Fact]
        public async Task SingleStoreMathSinTranslator()
        {
            var result = await _db.DataTypesSimple.Select(m =>
                new {
                    m.Id,
        ...
        [Fact]
        public async Task SingleStoreDateToDateTimeConvertTranslator()
        {
        ...
        [Fact]
        public async Task SingleStoreToStringConvertTranslator()
        {
        ...
        [Fact]
        public async Task SingleStoreCastTranslator()
        {
            var result = await _db.DataTypesSimple.Select(m => new {
