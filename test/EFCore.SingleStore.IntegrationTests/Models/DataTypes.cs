...
namespace EntityFrameworkCore.SingleStore.IntegrationTests.Models
{
	public class DataTypesSimple
	{
		...
		// DateTime
		public DateTime TypeDateTime { get; set; } = EmptyDateTime;
        public DateTimeOffset TypeDateTimeOffset { get; set; } = EmptyDateTimeOffset;
        public TimeSpan TypeTimeSpan { get; set; } = EmptyTimeSpan;
		// nullable DateTime
        ...
        public static readonly DateTime EmptyDateTime = new DateTime(1001, 1, 1, 0, 0, 0, 0);
        public static readonly DateTimeOffset EmptyDateTimeOffset = new DateTime(1001, 1, 1, 0, 0, 0, 0);
        public static readonly TimeSpan EmptyTimeSpan = new TimeSpan(0, -835, 59, 59, 0);
	}
