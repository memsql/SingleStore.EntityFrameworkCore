...
{
    public class SingleStoreGeometryMethodTranslator : IMethodCallTranslator
    {
        ...
        public SingleStoreGeometryMethodTranslator(
            ...
            return _sqlExpressionFactory.Case(
                new[]
                {
                    new CaseWhenClause(
                        ...
                        SingleStoreSpatialDbFunctionsExtensionsMethodTranslator.GetStDistanceSphereFunctionCall(
                            left,
                            right,
                ...
                SingleStoreSpatialDbFunctionsExtensionsMethodTranslator.GetStDistanceFunctionCall(
                    left,
                    right,
                    resultType,
                    resultTypeMapping,
