...
namespace EntityFrameworkCore.SingleStore.Storage.Internal
{
    ...
    ///     </para>
    /// </summary>
    public class SingleStoreNetTopologySuiteTypeMappingSourcePlugin : IRelationalTypeMappingSourcePlugin
    {
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public SingleStoreNetTopologySuiteTypeMappingSourcePlugin(
