...
{
    public class SingleStoreDbContextOptionsBuilder : RelationalDbContextOptionsBuilder<SingleStoreDbContextOptionsBuilder, SingleStoreOptionsExtension>
    {
        public SingleStoreDbContextOptionsBuilder([NotNull] DbContextOptionsBuilder optionsBuilder)
            : base(optionsBuilder)
        {
        }
        ...
        public virtual SingleStoreDbContextOptionsBuilder CharSet(CharSet charSet) // TODO: Remove for EF Core 6.
        ...
        /// </summary>
        public virtual SingleStoreDbContextOptionsBuilder EnableRetryOnFailure()
            => ExecutionStrategy(c => new SingleStoreRetryingExecutionStrategy(c));

        /// <summary>
        ///     Configures the context to use the default retrying <see cref="IExecutionStrategy" />.
        /// </summary>
        public virtual SingleStoreDbContextOptionsBuilder EnableRetryOnFailure(int maxRetryCount)
            => ExecutionStrategy(c => new SingleStoreRetryingExecutionStrategy(c, maxRetryCount));
        ...
        public virtual SingleStoreDbContextOptionsBuilder EnableRetryOnFailure(
            ...
            => ExecutionStrategy(c => new SingleStoreRetryingExecutionStrategy(c, maxRetryCount, maxRetryDelay, errorNumbersToAdd));
        ...
        public virtual SingleStoreDbContextOptionsBuilder DisableBackslashEscaping(bool setSqlModeOnOpen = true)
        {
        ...
        /// </summary>
        public virtual SingleStoreDbContextOptionsBuilder SetSqlModeOnOpen()
            => WithOption(e => e.WithSettingSqlModeOnOpen());

        /// <summary>
        ///     Skip replacing `\r` and `\n` with `CHAR()` calls in strings inside queries.
        /// </summary>
        public virtual SingleStoreDbContextOptionsBuilder DisableLineBreakToCharSubstition()
            => WithOption(e => e.WithDisabledLineBreakToCharSubstition());

        /// <summary>
        ///     Configures default mappings between specific CLR and MySQL types.
        /// </summary>
        public virtual SingleStoreDbContextOptionsBuilder DefaultDataTypeMappings(Func<SingleStoreDefaultDataTypeMappings, SingleStoreDefaultDataTypeMappings> defaultDataTypeMappings)
            => WithOption(e => e.WithDefaultDataTypeMappings(defaultDataTypeMappings(new SingleStoreDefaultDataTypeMappings())));
        ...
        ///     exception.
        /// </summary>
        public virtual SingleStoreDbContextOptionsBuilder SchemaBehavior(SingleStoreSchemaBehavior behavior, SingleStoreSchemaNameTranslator translator = null)
        ...
        /// </summary>
        public virtual SingleStoreDbContextOptionsBuilder EnableIndexOptimizedBooleanColumns(bool enable = true)
        ...
        /// </summary>
        public virtual SingleStoreDbContextOptionsBuilder LimitKeyedOrIndexedStringColumnLength(bool enable = true)
