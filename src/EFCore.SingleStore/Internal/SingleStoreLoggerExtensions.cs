...
namespace EntityFrameworkCore.SingleStore.Internal
{
    ...
    /// </summary>
    public static class SingleStoreLoggerExtensions
    {
        ...
        {
            var definition = SingleStoreResources.LogDefaultDecimalTypeColumn(diagnostics);
        ...
        public static void ByteIdentityColumnWarning(
            ...
            [NotNull] IProperty property)
        {
            var definition = SingleStoreResources.LogByteIdentityColumn(diagnostics);
        ...
        public static void ColumnFound(
            ...
            bool? stored)
        {
            var definition = SingleStoreResources.LogFoundColumn(diagnostics);
        ...
        {
            var definition = SingleStoreResources.LogFoundForeignKey(diagnostics);
        ...
        {
            var definition = SingleStoreResources.LogFoundDefaultSchema(diagnostics);
        ...
        {
            var definition = SingleStoreResources.LogFoundTypeAlias(diagnostics);
        ...
        public static void PrimaryKeyFound(
            ...
            [NotNull] string tableName)
        {
            var definition = SingleStoreResources.LogFoundPrimaryKey(diagnostics);
        ...
        public static void UniqueConstraintFound(
            ...
            [NotNull] string tableName)
        {
            var definition = SingleStoreResources.LogFoundUniqueConstraint(diagnostics);
        ...
        public static void IndexFound(
            ...
            bool unique)
        {
            var definition = SingleStoreResources.LogFoundIndex(diagnostics);
        ...
        {
            var definition = SingleStoreResources.LogPrincipalTableNotInSelectionSet(diagnostics);
        ...
        public static void ForeignKeyPrincipalColumnMissingWarning(
            ...
            [NotNull] string principalTableName)
        {
            var definition = SingleStoreResources.LogPrincipalColumnNotFound(diagnostics);
        ...
        {
            var definition = SingleStoreResources.LogMissingSchema(diagnostics);
        ...
        public static void MissingTableWarning(
            ...
            [CanBeNull] string tableName)
        {
            var definition = SingleStoreResources.LogMissingTable(diagnostics);
        ...
        {
            // No DiagnosticsSource events because these are purely design-time messages
            var definition = SingleStoreResources.LogFoundSequence(diagnostics);
        ...
        public static void TableFound(
            ...
            [NotNull] string tableName)
        {
            var definition = SingleStoreResources.LogFoundTable(diagnostics);
        ...
        {
            var definition = SingleStoreResources.LogDefaultValueNotSupported(diagnostics);
