...
{
    public static class SingleStoreModelBuilderExtensions
    {
        ...
        public static ModelBuilder AutoIncrementColumns(this ModelBuilder modelBuilder)
        {
            ...
            model.SetValueGenerationStrategy(SingleStoreValueGenerationStrategy.IdentityColumn);
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return modelBuilder.CanSetAnnotation(SingleStoreAnnotationNames.CharSet, charSet, fromDataAnnotation);
        }
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return modelBuilder.CanSetAnnotation(SingleStoreAnnotationNames.CharSetDelegation, delegationModes, fromDataAnnotation);
        }
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return modelBuilder.CanSetAnnotation(SingleStoreAnnotationNames.CollationDelegation, delegationModes, fromDataAnnotation);
        }
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return modelBuilder.CanSetAnnotation(SingleStoreAnnotationNames.GuidCollation, collation, fromDataAnnotation);
        }
