...
{
    public static class SingleStoreModelExtensions
    {
        #region ValueGenerationStrategy

        /// <summary>
        ///     Returns the <see cref="SingleStoreValueGenerationStrategy" /> to use for properties
        ...
        public static void SetValueGenerationStrategy([NotNull] this IMutableModel model, SingleStoreValueGenerationStrategy? value)
            => model.SetOrRemoveAnnotation(SingleStoreAnnotationNames.ValueGenerationStrategy, value);
        ...
        public static SingleStoreValueGenerationStrategy? SetValueGenerationStrategy(
            [NotNull] this IConventionModel model, SingleStoreValueGenerationStrategy? value, bool fromDataAnnotation = false)
        {
            model.SetOrRemoveAnnotation(SingleStoreAnnotationNames.ValueGenerationStrategy, value, fromDataAnnotation);

            return value;
        }

        /// <summary>
        ///     Returns the <see cref="ConfigurationSource" /> for the default <see cref="SingleStoreValueGenerationStrategy" />.
        /// </summary>
        /// <param name="model"> The model. </param>
        /// <returns> The <see cref="ConfigurationSource" /> for the default <see cref="SingleStoreValueGenerationStrategy" />. </returns>
        public static ConfigurationSource? GetValueGenerationStrategyConfigurationSource([NotNull] this IConventionModel model)
            => model.FindAnnotation(SingleStoreAnnotationNames.ValueGenerationStrategy)?.GetConfigurationSource();
        ...
        public static void SetCharSet([NotNull] this IMutableModel model, string charSet)
            => model.SetOrRemoveAnnotation(SingleStoreAnnotationNames.CharSet, charSet);
        ...
        {
            model.SetOrRemoveAnnotation(SingleStoreAnnotationNames.CharSet, charSet, fromDataAnnotation);
        ...
        public static ConfigurationSource? GetCharSetConfigurationSource([NotNull] this IConventionModel model)
            => model.FindAnnotation(SingleStoreAnnotationNames.CharSet)?.GetConfigurationSource();
        ...
        public static void SetCharSetDelegation([NotNull] this IMutableModel model, DelegationModes? delegationModes)
            => model.SetOrRemoveAnnotation(SingleStoreAnnotationNames.CharSetDelegation, delegationModes);
        ...
        {
            model.SetOrRemoveAnnotation(SingleStoreAnnotationNames.CharSetDelegation, delegationModes, fromDataAnnotation);
        ...
        public static ConfigurationSource? GetCharSetDelegationConfigurationSource([NotNull] this IConventionModel model)
            => model.FindAnnotation(SingleStoreAnnotationNames.CharSetDelegation)?.GetConfigurationSource();
        ...
        public static void SetCollationDelegation([NotNull] this IMutableModel model, DelegationModes? delegationModes)
            => model.SetOrRemoveAnnotation(SingleStoreAnnotationNames.CollationDelegation, delegationModes);
        ...
        {
            model.SetOrRemoveAnnotation(SingleStoreAnnotationNames.CollationDelegation, delegationModes, fromDataAnnotation);
        ...
        public static ConfigurationSource? GetCollationDelegationConfigurationSource([NotNull] this IConventionModel model)
            => model.FindAnnotation(SingleStoreAnnotationNames.CollationDelegation)?.GetConfigurationSource();
        ...
        public static void SetGuidCollation([NotNull] this IMutableModel model, string collation)
            => model.SetOrRemoveAnnotation(SingleStoreAnnotationNames.GuidCollation, collation);
        ...
        {
            model.SetOrRemoveAnnotation(SingleStoreAnnotationNames.GuidCollation, collation, fromDataAnnotation);
        ...
        public static ConfigurationSource? GetGuidCollationConfigurationSource([NotNull] this IConventionModel model)
            => model.FindAnnotation(SingleStoreAnnotationNames.GuidCollation)?.GetConfigurationSource();
