...
namespace Microsoft.EntityFrameworkCore
{
    ...
    /// </summary>
    public static class SingleStoreEntityTypeExtensions
    {
        #region CharSet
            ...
            [CanBeNull] string charSet)
        {
            ...
            entityType.SetOrRemoveAnnotation(SingleStoreAnnotationNames.CharSet, charSet);
        }
            ...
            bool fromDataAnnotation = false)
        {
            ...
            entityType.SetOrRemoveAnnotation(SingleStoreAnnotationNames.CharSet, charSet, fromDataAnnotation);
        ...
        public static ConfigurationSource? GetCharSetConfigurationSource([NotNull] this IConventionEntityType entityType)
            => entityType.FindAnnotation(SingleStoreAnnotationNames.CharSet)?.GetConfigurationSource();
        ...
        public static void SetCharSetDelegation(
            ...
            => entityType.SetOrRemoveAnnotation(SingleStoreAnnotationNames.CharSetDelegation, delegationModes);
        ...
        public static DelegationModes? SetCharSetDelegation(
            ...
            bool fromDataAnnotation = false)
        {
            entityType.SetOrRemoveAnnotation(SingleStoreAnnotationNames.CharSetDelegation, delegationModes, fromDataAnnotation);
        ...
        public static ConfigurationSource? GetCharSetDelegationConfigurationSource([NotNull] this IConventionEntityType entityType)
            => entityType.FindAnnotation(SingleStoreAnnotationNames.CharSetDelegation)?.GetConfigurationSource();
        ...
        public static void SetCollationDelegation(
            [NotNull] this IMutableEntityType entityType,
            [CanBeNull] DelegationModes? delegationModes)
            => entityType.SetOrRemoveAnnotation(SingleStoreAnnotationNames.CollationDelegation, delegationModes);
        ...
        public static DelegationModes? SetCollationDelegation(
            ...
            bool fromDataAnnotation = false)
        {
            entityType.SetOrRemoveAnnotation(SingleStoreAnnotationNames.CollationDelegation, delegationModes, fromDataAnnotation);
        ...
        public static ConfigurationSource? GetCollationDelegationConfigurationSource([NotNull] this IConventionEntityType entityType)
            => entityType.FindAnnotation(SingleStoreAnnotationNames.CollationDelegation)?.GetConfigurationSource();
        ...
        public static void SetTableOptions(
            ...
            => entityType.SetOrRemoveAnnotation(SingleStoreAnnotationNames.StoreOptions, SerializeTableOptions(options));
        ...
        public static Dictionary<string, string> SetTableOptions(
            ...
            bool fromDataAnnotation = false)
        {
            entityType.SetOrRemoveAnnotation(SingleStoreAnnotationNames.StoreOptions, SerializeTableOptions(options), fromDataAnnotation);
        ...
        public static ConfigurationSource? GetTableOptionsConfigurationSource([NotNull] this IConventionEntityType entityType)
            => entityType.FindAnnotation(SingleStoreAnnotationNames.StoreOptions)?.GetConfigurationSource();
