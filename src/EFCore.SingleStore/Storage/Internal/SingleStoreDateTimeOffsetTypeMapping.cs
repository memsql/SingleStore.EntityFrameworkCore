...
namespace EntityFrameworkCore.SingleStore.Storage.Internal
{
    ...
    /// </summary>
    public class SingleStoreDateTimeOffsetTypeMapping : DateTimeOffsetTypeMapping, IDefaultValueCompatibilityAware
    {
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public SingleStoreDateTimeOffsetTypeMapping(
        ...
        /// </summary>
        protected SingleStoreDateTimeOffsetTypeMapping(RelationalTypeMappingParameters parameters, bool isDefaultValueCompatible)
            : base(parameters)
        {
        ...
        protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
            => new SingleStoreDateTimeOffsetTypeMapping(parameters, _isDefaultValueCompatible);
        ...
        public virtual RelationalTypeMapping Clone(bool isDefaultValueCompatible = false)
            => new SingleStoreDateTimeOffsetTypeMapping(Parameters, isDefaultValueCompatible);
