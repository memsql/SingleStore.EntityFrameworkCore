...
namespace EntityFrameworkCore.SingleStore.Storage.Internal
{
    ...
    public class SingleStoreDateTimeTypeMapping : DateTimeTypeMapping, IDefaultValueCompatibilityAware
    {
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public SingleStoreDateTimeTypeMapping(
        ...
        /// </summary>
        protected SingleStoreDateTimeTypeMapping(RelationalTypeMappingParameters parameters, bool isDefaultValueCompatible)
            : base(parameters)
        {
        ...
        protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
            => new SingleStoreDateTimeTypeMapping(parameters, _isDefaultValueCompatible);
        ...
        public virtual RelationalTypeMapping Clone(bool isDefaultValueCompatible = false)
            => new SingleStoreDateTimeTypeMapping(Parameters, isDefaultValueCompatible);
