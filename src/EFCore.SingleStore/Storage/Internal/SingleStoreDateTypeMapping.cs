...
namespace EntityFrameworkCore.SingleStore.Storage.Internal
{
    ...
    ///     </para>
    /// </summary>
    public class SingleStoreDateTypeMapping : RelationalTypeMapping, IDefaultValueCompatibilityAware
    {
        ...
        /// </summary>
        protected SingleStoreDateTypeMapping(RelationalTypeMappingParameters parameters, bool isDefaultValueCompatible)
            : base(parameters)
        {
        ...
        protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
            => new SingleStoreDateTypeMapping(parameters, _isDefaultValueCompatible);
        ...
        public virtual RelationalTypeMapping Clone(bool isDefaultValueCompatible = false)
            => new SingleStoreDateTypeMapping(Parameters, isDefaultValueCompatible);
