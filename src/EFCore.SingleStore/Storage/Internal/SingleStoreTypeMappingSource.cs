...
namespace EntityFrameworkCore.SingleStore.Storage.Internal
{
    ...
    public class SingleStoreTypeMappingSource : RelationalTypeMappingSource
    {
        // boolean
        ...
        private SingleStoreStringTypeMapping _charUnicode;
        private SingleStoreStringTypeMapping _varcharUnicode;
        private SingleStoreStringTypeMapping _tinytextUnicode;
        private SingleStoreStringTypeMapping _textUnicode;
        private SingleStoreStringTypeMapping _mediumtextUnicode;
        private SingleStoreStringTypeMapping _longtextUnicode;

        private SingleStoreStringTypeMapping _nchar;
        private SingleStoreStringTypeMapping _nvarchar;
        ...
        private readonly RelationalTypeMapping _binaryRowVersion
            = new SingleStoreDateTimeTypeMapping(
                "timestamp",
                null,
                typeof(byte[]),
        ...
        public SingleStoreTypeMappingSource(
        ...
        private void Initialize()
        {
            ...
            _clrTypeMappings
                = new Dictionary<Type, RelationalTypeMapping>
                {
                    ...
                    // json
                    { typeof(SingleStoreJsonString), _jsonDefaultString }
                };

            // Boolean
            if (_options.DefaultDataTypeMappings.ClrBoolean != SingleStoreBooleanType.None)
            {
                var bit1AsBool = _options.DefaultDataTypeMappings.ClrBoolean == SingleStoreBooleanType.Bit1;
            ...
            {
                { typeof(SingleStoreCodeGenerationMemberAccess), _codeGenerationMemberAccess },
                { typeof(SingleStoreCodeGenerationServerVersionCreation), _codeGenerationServerVersionCreation },
            };
        }
        ...
        private RelationalTypeMapping FindRawMapping(RelationalTypeMappingInfo mappingInfo)
        {
            ...
            if (storeTypeName != null)
            {
                ...
                if (storeTypeName.Equals("json", StringComparison.OrdinalIgnoreCase) &&
                    (clrType == null || clrType == typeof(string) || clrType == typeof(SingleStoreJsonString)))
                {
