...
namespace EntityFrameworkCore.SingleStore.Storage.Internal
{
    ...
    /// </summary>
    public class SingleStoreTimeTypeMapping : RelationalTypeMapping, IDefaultValueCompatibilityAware
    {
        ...
        /// </summary>
        public SingleStoreTimeTypeMapping(
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        protected SingleStoreTimeTypeMapping(RelationalTypeMappingParameters parameters, bool isDefaultValueCompatible)
            : base(parameters)
        {
        ...
        protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
            => new SingleStoreTimeTypeMapping(parameters, _isDefaultValueCompatible);
        ...
        public virtual RelationalTypeMapping Clone(bool isDefaultValueCompatible = false)
            => new SingleStoreTimeTypeMapping(Parameters, isDefaultValueCompatible);
