...
namespace EntityFrameworkCore.SingleStore.Internal
{
    ...
    /// </summary>
    public static class SingleStoreStrings
    {
        ...
        /// <summary>
        ///     An exception has been raised that is likely due to a transient failure. Consider enabling transient error resiliency by adding 'EnableRetryOnFailure()' to the 'UseSingleStore' call.
        /// </summary>
...
namespace EntityFrameworkCore.SingleStore.Internal
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public static class SingleStoreResources
    {
        private static readonly ResourceManager _resourceManager
            = new ResourceManager("EntityFrameworkCore.SingleStore.Properties.SingleStoreStrings", typeof(SingleStoreResources).GetTypeInfo().Assembly);
        ...
        {
            var definition = ((Diagnostics.Internal.SingleStoreLoggingDefinitions)logger.Definitions).LogDefaultDecimalTypeColumn;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((Diagnostics.Internal.SingleStoreLoggingDefinitions)logger.Definitions).LogDefaultDecimalTypeColumn,
                    () => new EventDefinition<string, string>(
                        logger.Options,
                        SingleStoreEventId.DecimalTypeDefaultWarning,
                        LogLevel.Warning,
                        "SingleStoreEventId.DecimalTypeDefaultWarning",
        ...
        {
            var definition = ((Diagnostics.Internal.SingleStoreLoggingDefinitions)logger.Definitions).LogByteIdentityColumn;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((Diagnostics.Internal.SingleStoreLoggingDefinitions)logger.Definitions).LogByteIdentityColumn,
                    () => new EventDefinition<string, string>(
                        logger.Options,
                        SingleStoreEventId.ByteIdentityColumnWarning,
                        LogLevel.Warning,
                        "SingleStoreEventId.ByteIdentityColumnWarning",
                        level => LoggerMessage.Define<string, string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.SingleStoreLoggingDefinitions)logger.Definitions).LogFoundDefaultSchema;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((Diagnostics.Internal.SingleStoreLoggingDefinitions)logger.Definitions).LogFoundDefaultSchema,
                    () => new EventDefinition<string>(
                        logger.Options,
                        SingleStoreEventId.DefaultSchemaFound,
                        LogLevel.Debug,
                        "SingleStoreEventId.DefaultSchemaFound",
        ...
        {
            var definition = ((Diagnostics.Internal.SingleStoreLoggingDefinitions)logger.Definitions).LogFoundTypeAlias;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((Diagnostics.Internal.SingleStoreLoggingDefinitions)logger.Definitions).LogFoundTypeAlias,
                    () => new EventDefinition<string, string>(
                        logger.Options,
                        SingleStoreEventId.TypeAliasFound,
                        LogLevel.Debug,
                        "SingleStoreEventId.TypeAliasFound",
                        level => LoggerMessage.Define<string, string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.SingleStoreLoggingDefinitions)logger.Definitions).LogFoundColumn;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((Diagnostics.Internal.SingleStoreLoggingDefinitions)logger.Definitions).LogFoundColumn,
                    () => new FallbackEventDefinition(
                        logger.Options,
                        SingleStoreEventId.ColumnFound,
                        LogLevel.Debug,
                        "SingleStoreEventId.ColumnFound",
        ...
        {
            var definition = ((Diagnostics.Internal.SingleStoreLoggingDefinitions)logger.Definitions).LogFoundForeignKey;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((Diagnostics.Internal.SingleStoreLoggingDefinitions)logger.Definitions).LogFoundForeignKey,
                    () => new EventDefinition<string, string, string, string>(
                        logger.Options,
                        SingleStoreEventId.ForeignKeyFound,
                        LogLevel.Debug,
                        "SingleStoreEventId.ForeignKeyFound",
        ...
        {
            var definition = ((Diagnostics.Internal.SingleStoreLoggingDefinitions)logger.Definitions).LogPrincipalTableNotInSelectionSet;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((Diagnostics.Internal.SingleStoreLoggingDefinitions)logger.Definitions).LogPrincipalTableNotInSelectionSet,
                    () => new EventDefinition<string, string, string>(
                        logger.Options,
                        SingleStoreEventId.ForeignKeyReferencesMissingPrincipalTableWarning,
                        LogLevel.Warning,
                        "SingleStoreEventId.ForeignKeyReferencesMissingPrincipalTableWarning",
        ...
        {
            var definition = ((Diagnostics.Internal.SingleStoreLoggingDefinitions)logger.Definitions).LogMissingSchema;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((Diagnostics.Internal.SingleStoreLoggingDefinitions)logger.Definitions).LogMissingSchema,
                    () => new EventDefinition<string>(
                        logger.Options,
                        SingleStoreEventId.MissingSchemaWarning,
                        LogLevel.Warning,
                        "SingleStoreEventId.MissingSchemaWarning",
                        level => LoggerMessage.Define<string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.SingleStoreLoggingDefinitions)logger.Definitions).LogMissingTable;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((Diagnostics.Internal.SingleStoreLoggingDefinitions)logger.Definitions).LogMissingTable,
                    () => new EventDefinition<string>(
                        logger.Options,
                        SingleStoreEventId.MissingTableWarning,
                        LogLevel.Warning,
                        "SingleStoreEventId.MissingTableWarning",
                        level => LoggerMessage.Define<string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.SingleStoreLoggingDefinitions)logger.Definitions).LogFoundSequence;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((Diagnostics.Internal.SingleStoreLoggingDefinitions)logger.Definitions).LogFoundSequence,
                    () => new FallbackEventDefinition(
                        logger.Options,
                        SingleStoreEventId.SequenceFound,
                        LogLevel.Debug,
                        "SingleStoreEventId.SequenceFound",
        ...
        {
            var definition = ((Diagnostics.Internal.SingleStoreLoggingDefinitions)logger.Definitions).LogFoundTable;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((Diagnostics.Internal.SingleStoreLoggingDefinitions)logger.Definitions).LogFoundTable,
                    () => new EventDefinition<string>(
                        logger.Options,
                        SingleStoreEventId.TableFound,
                        LogLevel.Debug,
                        "SingleStoreEventId.TableFound",
                        level => LoggerMessage.Define<string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.SingleStoreLoggingDefinitions)logger.Definitions).LogFoundIndex;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((Diagnostics.Internal.SingleStoreLoggingDefinitions)logger.Definitions).LogFoundIndex,
                    () => new EventDefinition<string, string, bool>(
                        logger.Options,
                        SingleStoreEventId.IndexFound,
                        LogLevel.Debug,
                        "SingleStoreEventId.IndexFound",
        ...
        {
            var definition = ((Diagnostics.Internal.SingleStoreLoggingDefinitions)logger.Definitions).LogFoundPrimaryKey;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((Diagnostics.Internal.SingleStoreLoggingDefinitions)logger.Definitions).LogFoundPrimaryKey,
                    () => new EventDefinition<string, string>(
                        logger.Options,
                        SingleStoreEventId.PrimaryKeyFound,
                        LogLevel.Debug,
                        "SingleStoreEventId.PrimaryKeyFound",
                        level => LoggerMessage.Define<string, string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.SingleStoreLoggingDefinitions)logger.Definitions).LogFoundUniqueConstraint;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((Diagnostics.Internal.SingleStoreLoggingDefinitions)logger.Definitions).LogFoundUniqueConstraint,
                    () => new EventDefinition<string, string>(
                        logger.Options,
                        SingleStoreEventId.UniqueConstraintFound,
                        LogLevel.Debug,
                        "SingleStoreEventId.UniqueConstraintFound",
                        level => LoggerMessage.Define<string, string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.SingleStoreLoggingDefinitions)logger.Definitions).LogPrincipalColumnNotFound;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((Diagnostics.Internal.SingleStoreLoggingDefinitions)logger.Definitions).LogPrincipalColumnNotFound,
                    () => new EventDefinition<string, string, string, string>(
                        logger.Options,
                        SingleStoreEventId.ForeignKeyPrincipalColumnMissingWarning,
                        LogLevel.Warning,
                        "SingleStoreEventId.ForeignKeyPrincipalColumnMissingWarning",
                        level => LoggerMessage.Define<string, string, string, string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.SingleStoreLoggingDefinitions)logger.Definitions).LogDefaultValueNotSupported;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((Diagnostics.Internal.SingleStoreLoggingDefinitions)logger.Definitions).LogDefaultValueNotSupported,
                    () => new EventDefinition<string, string, string>(
                        logger.Options,
                        SingleStoreEventId.DefaultValueNotSupportedWarning,
                        LogLevel.Warning,
                        "SingleStoreEventId.DefaultValueNotSupportedWarning",
                        level => LoggerMessage.Define<string, string, string>(
                            level,
