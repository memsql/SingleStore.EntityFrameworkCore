    ...
    public class SingleStoreStringMethodTranslator : SingleStoreQueryCompilationContextMethodTranslator
    {
            ...
            QueryCompilationContext queryCompilationContext)
        {
                    ...
                    : null) ?? method))
            {
                ...
                // is translated.
                var concatArguments = arguments[0] is SingleStoreComplexFunctionArgumentExpression mySqlComplexFunctionArgumentExpression
                ...
                // We haven't implemented expansion of SingleStoreComplexFunctionArgumentExpression yet, so the default nullability check would
