...
namespace EntityFrameworkCore.SingleStore.Query.Internal
{
    ...
    /// </summary>
    public class SingleStoreObjectToStringTranslator : IMethodCallTranslator
    {
        ...
        public SingleStoreObjectToStringTranslator(ISqlExpressionFactory sqlExpressionFactory)
        {
