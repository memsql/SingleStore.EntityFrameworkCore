...
namespace EntityFrameworkCore.SingleStore.Query.Internal
{
    ...
    public class SingleStoreSqlNullabilityProcessor : SqlNullabilityProcessor
    {
        ...
        protected override SqlExpression VisitCustomSqlExpression(
            ...
            {
                SingleStoreBinaryExpression binaryExpression => VisitBinary(binaryExpression, allowOptimizedExpansion, out nullable),
                SingleStoreCollateExpression collateExpression => VisitCollate(collateExpression, allowOptimizedExpansion, out nullable),
                SingleStoreComplexFunctionArgumentExpression complexFunctionArgumentExpression => VisitComplexFunctionArgument(complexFunctionArgumentExpression, allowOptimizedExpansion, out nullable),
                SingleStoreMatchExpression matchExpression => VisitMatch(matchExpression, allowOptimizedExpansion, out nullable),
                SingleStoreJsonArrayIndexExpression arrayIndexExpression => VisitJsonArrayIndex(arrayIndexExpression, allowOptimizedExpansion, out nullable),
                SingleStoreJsonTraversalExpression jsonTraversalExpression => VisitJsonTraversal(jsonTraversalExpression, allowOptimizedExpansion, out nullable),
                SingleStoreRegexpExpression regexpExpression => VisitRegexp(regexpExpression, allowOptimizedExpansion, out nullable),
                SingleStoreColumnAliasReferenceExpression columnAliasReferenceExpression => VisitColumnAliasReference(columnAliasReferenceExpression, allowOptimizedExpansion, out nullable),
                _ => base.VisitCustomSqlExpression(sqlExpression, allowOptimizedExpansion, out nullable)
            };

        private SqlExpression VisitColumnAliasReference(SingleStoreColumnAliasReferenceExpression columnAliasReferenceExpression, bool allowOptimizedExpansion, out bool nullable)
        {
        ...
        /// <summary>
        /// Visits a <see cref="SingleStoreBinaryExpression" /> and computes its nullability.
        /// </summary>
        /// <param name="binaryExpression">A <see cref="SingleStoreBinaryExpression" /> expression to visit.</param>
        ...
        protected virtual SqlExpression VisitBinary(
            [NotNull] SingleStoreBinaryExpression binaryExpression, bool allowOptimizedExpansion, out bool nullable)
        {
        ...
        /// <summary>
        /// Visits a <see cref="SingleStoreCollateExpression" /> and computes its nullability.
        /// </summary>
        /// <param name="collateExpression">A <see cref="SingleStoreCollateExpression" /> expression to visit.</param>
        /// <param name="allowOptimizedExpansion">A bool value indicating if optimized expansion which considers null value as false value is allowed.</param>
        /// <param name="nullable">A bool value indicating whether the sql expression is nullable.</param>
        /// <returns>An optimized sql expression.</returns>
        protected virtual SqlExpression VisitCollate(
            [NotNull] SingleStoreCollateExpression collateExpression, bool allowOptimizedExpansion, out bool nullable)
        {
        ...
        /// <summary>
        /// Visits a <see cref="SingleStoreComplexFunctionArgumentExpression" /> and computes its nullability.
        /// </summary>
        /// <param name="complexFunctionArgumentExpression">A <see cref="SingleStoreComplexFunctionArgumentExpression" /> expression to visit.</param>
        /// <param name="allowOptimizedExpansion">A bool value indicating if optimized expansion which considers null value as false value is allowed.</param>
        /// <param name="nullable">A bool value indicating whether the sql expression is nullable.</param>
        /// <returns>An optimized sql expression.</returns>
        protected virtual SqlExpression VisitComplexFunctionArgument(
            [NotNull] SingleStoreComplexFunctionArgumentExpression complexFunctionArgumentExpression, bool allowOptimizedExpansion, out bool nullable)
        {
        ...
        /// <summary>
        /// Visits a <see cref="SingleStoreMatchExpression" /> and computes its nullability.
        /// </summary>
        /// <param name="matchExpression">A <see cref="SingleStoreMatchExpression" /> expression to visit.</param>
        /// <param name="allowOptimizedExpansion">A bool value indicating if optimized expansion which considers null value as false value is allowed.</param>
        /// <param name="nullable">A bool value indicating whether the sql expression is nullable.</param>
        /// <returns>An optimized sql expression.</returns>
        protected virtual SqlExpression VisitMatch(
            [NotNull] SingleStoreMatchExpression matchExpression, bool allowOptimizedExpansion, out bool nullable)
        {
        ...
        /// <summary>
        /// Visits an <see cref="SingleStoreJsonArrayIndexExpression" /> and computes its nullability.
        /// </summary>
        /// <param name="jsonArrayIndexExpression">A <see cref="SingleStoreJsonArrayIndexExpression" /> expression to visit.</param>
        /// <param name="allowOptimizedExpansion">A bool value indicating if optimized expansion which considers null value as false value is allowed.</param>
        /// <param name="nullable">A bool value indicating whether the sql expression is nullable.</param>
        /// <returns>An optimized sql expression.</returns>
        protected virtual SqlExpression VisitJsonArrayIndex(
            [NotNull] SingleStoreJsonArrayIndexExpression jsonArrayIndexExpression, bool allowOptimizedExpansion, out bool nullable)
        {
        ...
        /// <summary>
        /// Visits a <see cref="SingleStoreJsonTraversalExpression" /> and computes its nullability.
        /// </summary>
        /// <param name="jsonTraversalExpression">A <see cref="SingleStoreJsonTraversalExpression" /> expression to visit.</param>
        /// <param name="allowOptimizedExpansion">A bool value indicating if optimized expansion which considers null value as false value is allowed.</param>
        /// <param name="nullable">A bool value indicating whether the sql expression is nullable.</param>
        /// <returns>An optimized sql expression.</returns>
        protected virtual SqlExpression VisitJsonTraversal(
            [NotNull] SingleStoreJsonTraversalExpression jsonTraversalExpression, bool allowOptimizedExpansion, out bool nullable)
        {
        ...
        /// <summary>
        /// Visits a <see cref="SingleStoreRegexpExpression" /> and computes its nullability.
        /// </summary>
        /// <param name="regexpExpression">A <see cref="SingleStoreRegexpExpression" /> expression to visit.</param>
        /// <param name="allowOptimizedExpansion">A bool value indicating if optimized expansion which considers null value as false value is allowed.</param>
        /// <param name="nullable">A bool value indicating whether the sql expression is nullable.</param>
        /// <returns>An optimized sql expression.</returns>
        protected virtual SqlExpression VisitRegexp(
            [NotNull] SingleStoreRegexpExpression regexpExpression, bool allowOptimizedExpansion, out bool nullable)
        {
