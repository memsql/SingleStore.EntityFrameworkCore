...
{
    public class SingleStoreMathMethodTranslator : IMethodCallTranslator
    {
        ...
        public SingleStoreMathMethodTranslator(SingleStoreSqlExpressionFactory sqlExpressionFactory)
