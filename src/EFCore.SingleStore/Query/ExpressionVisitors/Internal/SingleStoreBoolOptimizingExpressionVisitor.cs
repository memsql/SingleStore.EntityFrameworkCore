...
namespace EntityFrameworkCore.SingleStore.Query.ExpressionVisitors.Internal
{
    ...
    public class SingleStoreBoolOptimizingExpressionVisitor : SqlExpressionVisitor
    {
        ...
        public SingleStoreBoolOptimizingExpressionVisitor(
        ...
        private Expression ApplyConversion(SqlExpression sqlExpression, bool condition)
        {
            if (_optimize &&
                ...
                sqlExpression.TypeMapping is SingleStoreBoolTypeMapping &&
        ...
        protected override Expression VisitSqlBinary(SqlBinaryExpression sqlBinaryExpression)
        {
            ...
            //       See `GearsOfWarQuerySingleStoreTest`.
            ...
            if (_optimize &&
                ...
                columnExpression.TypeMapping is SingleStoreBoolTypeMapping &&
                columnExpression.Type == typeof(bool) &&
                sqlConstantExpression.TypeMapping is SingleStoreBoolTypeMapping &&
