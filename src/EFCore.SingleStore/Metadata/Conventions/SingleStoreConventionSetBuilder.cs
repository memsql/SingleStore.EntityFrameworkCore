...
namespace Microsoft.EntityFrameworkCore.Metadata.Conventions
{
    ...
    /// </summary>
    public class SingleStoreConventionSetBuilder : RelationalConventionSetBuilder
    {
        /// <summary>
        ///     This API supports the Entity Framework Core infrastructure and is not intended to be used
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public SingleStoreConventionSetBuilder(
        ...
        public override ConventionSet CreateConventionSet()
        {
            ...
            var valueGenerationConvention = new SingleStoreValueGenerationConvention(Dependencies, RelationalDependencies);
        ...
        public static ConventionSet Build()
        {
            var serviceProvider = new ServiceCollection()
                ...
                .AddDbContext<DbContext>(o => o.UseSingleStore("Server=."))
