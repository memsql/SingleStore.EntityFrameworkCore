...
/// </summary>
public class SingleStoreModificationCommandBatch : AffectedCountModificationCommandBatch
{
    private readonly List<IReadOnlyModificationCommand> _pendingBulkInsertCommands = new();

    public SingleStoreModificationCommandBatch(
    ...
    protected new virtual ISingleStoreUpdateSqlGenerator UpdateSqlGenerator
        => (ISingleStoreUpdateSqlGenerator)base.UpdateSqlGenerator;
